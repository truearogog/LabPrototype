namespace LabPrototype.Domain.Models.Meters
{
    public class MeterOne : Meter
    {
        ...
        {
            new MeasurementAttribute("Q1",  "m³/h", x => x.Q1,      "Q1",       ColorScheme.Red),
            new MeasurementAttribute("Q2",  "m³/h", x => x.Q2,      "Q2",       ColorScheme.Blue),
            new MeasurementAttribute("ΔQ",  "m³/h", x => x.DeltaQ,  "DeltaQ",   ColorScheme.Yellow),
            new MeasurementAttribute("P",   "MW",   x => x.P,       "P",        ColorScheme.Purple),
            new MeasurementAttribute("T",   "°C",   x => x.T,       "T",        ColorScheme.Green),
        };
